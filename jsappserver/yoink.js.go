...
func loader_yoink_js() (*asset, error) {
	bytes, err := loader_yoink_js_bytes()
	if err != nil {
		return nil, err
	}

	info := bindata_file_info{name: "../loader/yoink.js", size: 8570, mode: os.FileMode(420), modTime: time.Unix(1414905810, 0)}
...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	"..": &_bintree_t{nil, map[string]*_bintree_t{
		"loader": &_bintree_t{nil, map[string]*_bintree_t{
			"yoink.js": &_bintree_t{loader_yoink_js, map[string]*_bintree_t{
			}},
		}},
	}},
}}
